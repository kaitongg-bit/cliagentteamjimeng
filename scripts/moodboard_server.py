...
DEFAULT_CARDS = [
    {
        ...
        "look_for": ["门口视角", "狭小房间纵深", "背对镜头的人", "电脑屏幕作为实际光源", "当代低配办公电脑"],
        "avoid": ["赛博朋克剪辑室", "复古 CRT 电脑", "漂亮的电影化贫穷", "年代戏感"],
        "suggested_search_terms": {
            "zh": ["出租屋 门口 电脑 背影", "旧小区出租屋 漏水 电脑桌", "屏幕光 背影 出租屋"],
            "en": ["cramped apartment doorway computer back view", "low income room computer screen light"],
        },
        "reference_targets": [
            {"title": "纪录片式出租屋/打工人影像", "watch_for": "空间如何压过人物，而不是人物摆拍。"},
            {"title": "手机随手拍室内照片", "watch_for": "坏白平衡、错焦、门框遮挡。"},
        ],
        "human_notes": "",
    },
    {
        "card_id": "MB_002",
        "scene_id": "S01",
        "shot_name": "漏水房间：盆、剧本、插线板、屏幕反光",
        "status": "unresolved",
        "dramatic_function": "把失业处境和剪辑劳动压缩进一个物理危险的空间。",
        "viewer_should_feel": "不是苦情，是一种生活随时短路的低级恐惧。",
        "look_for": ["水盆位置", "桌面与地面的空间关系", "潮湿墙面", "插线板的现实危险", "屏幕反光"],
        "avoid": ["惊悚片电火花", "过度戏剧化漏水", "摆拍道具清单"],
        "suggested_search_terms": {
            "zh": ["出租屋 漏水 水盆 插线板", "旧房间 潮湿 墙面 电脑桌", "雨天 室内 漏水"],
            "en": ["leaking apartment basin power strip desk", "damp room computer desk rain"],
        },
        "reference_targets": [{"title": "真实租房漏水照片", "watch_for": "物件如何随手垫高，不要漂亮置景。"}],
        "human_notes": "",
    },
    {
        "card_id": "MB_003",
    ...
    },
    {
        ...
        "look_for": ["空椅子", "还亮着的电脑", "清晨灰光", "水盆余波", "房间无人但仍运行"],
